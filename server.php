...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($username)) { array_push($errors, "*Bạn Cần Nhập Tài Khoản "); }
  if (empty($email)) { array_push($errors, "*Vui Lòng Điền Địa Chỉ Email"); }
  if (empty($password_1)) { array_push($errors, "*Bạn Cần Nhập Mật Khẩu"); }
